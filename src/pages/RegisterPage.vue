          ...
          <q-card class="my-card">
            <q-card-section class="text-dark">
              <center>
                <a href="/"
                  ><img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Moon_in_Sunrise_Sky_2.jpg/170px-Moon_in_Sunrise_Sky_2.jpg"
                    style="width: 130px"
                /></a>
                <br />
...
import register from "src/firebase/FirebaseRegister";
